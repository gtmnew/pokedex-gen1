...
const setTypeBackgroundColor = (pokemon) => {
  ...
  const statsWrapElements = document.querySelectorAll(".stats-wrap p.stats");
  setElementStyles(statsWrapElements, "color", color);

  const progressBarElements = document.querySelectorAll(
    ".stats-wrap .progress-bar"
  );
  setElementStyles(progressBarElements, "color", color);
